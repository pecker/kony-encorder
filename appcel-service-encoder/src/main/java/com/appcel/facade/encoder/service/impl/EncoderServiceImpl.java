...
public class EncoderServiceImpl implements EncoderService {
	 ...
	 *             If a problem occurs calling the underlying ffmpeg executable.
	 */
	private MultimediaInfo parseMultimediaInfo(File source, EncoderBufferedReader reader) throws InputFormatException, EncoderException {
	 ...
	 */
	public void encode(File source, File target, EncodingAttributes attributes) throws IllegalArgumentException, InputFormatException,
			EncoderException {
	...
	public void encode(File source, File target, EncodingAttributes attributes, EncoderProgressListener listener)
		...
		if (videoAttributes == null) {
			...
			if (size != null) {
				...
				encoderExcutor.addArgument(String.valueOf(size.getWidth()) + "x" + String.valueOf(size.getHeight()));
			}
		}
